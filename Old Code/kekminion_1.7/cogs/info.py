...
# Shows information about a particular user or a list of information of available options.
    ...
    async def info(self, ctx, *, username=None):
        ...
        if (username.lower() in otherNames[0]):  #KeK Incorporated
            ...
            await ctx.reply(embed=embed, mention_author=False)
            print("Info command used, username typed: [ " + username + " ]")
        elif username.lower() in usernames[12]:  #Cooper
            embed = discord.Embed(
                title="",
                description=
            ...
            await ctx.reply(embed=embed, mention_author=False)
            print("Info command used, username typed: [ " + username + " ]")
        elif username.lower() in usernames[13]:  #Liam
            embed = discord.Embed(
                title="",
                description=
                f"**Location**: New Jersey \n \n **Socials** \n # Discord | <@358650473055780864> \n ---------------------- \n **Schedule** \n __Monday__ \n # Electronics Devices | <t:1684157400:t>-<t:1684169400:t> \n # Intro-Info&Netw Sec | <t:1684170600:t>-<t:1684175400:t> \n # Comp Arch & Asm Lang | <t:1684177200:t>-<t:1684182000:t> \n # Linear Sys & Signals | <t:1684183800:t>-<t:1684188600:t> \n __Wednesday__ \n # Electron Devices Lab | <t:1684157400:t>-<t:1684211400:t> \n # Comp Arch & Asm Lang | <t:1684177200:t>-<t:1684182000:t> \n # Linear Sys & Signals | <t:1684203600:t>-<t:1684208400:t> \n __Thursday__ \n # Electronics Devices | <t:1684157400:t>-<t:1684169400:t> \n # Intro-Info&Netw Sec | <t:1684170600:t>-<t:1684175400:t> \n # Computer Archit Lab | <t:1684177200:t>-<t:1684188000:t>",
                color=0x44ff44)
